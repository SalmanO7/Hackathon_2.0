        ...
        <div>
            {orders && orders.length > 0 ? (
                orders.map((order: any) => (
                    <div key={order._id} className="bg-white shadow-md rounded-lg p-6 mb-6 max-w-3xl mx-auto">
                  
                        <div className="flex items-center justify-between mb-4">
                            <h2 className="text-2xl font-semibold text-gray-800">Order by {order.user?.name || 'Unknown User'}</h2>
                        ...
                        <div className="mb-4">
                            <p className="text-gray-700">Email: <span className="font-medium">{order.user?.email}</span></p>
                            <p className="text-gray-700">Contact: <span className="font-medium">{order.user?.contact}</span></p>
